...
function Strip() {
  return (
    <div className="mb-32">
      <div className="overflow-hidden w-full h-[100px]  relative z-10 p-3 bg-[#F6B620]">
      ...
      <div className="overflow-hidden w-full  -ml-3 p-3  h-[100px] absolute -mt-[90px] bg-black -rotate-6">
        <div className=" flex items-center space-x-8">
          <div className="flex items-center space-x-6">
            <Image src="/assets/star.svg" alt="star" width={50} height={50} />
            <h1 className="text-[38px] font-bold text-white">Osceolla</h1>
