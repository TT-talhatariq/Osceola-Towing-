            ...
            ? data.map((item: Item, index: number) => {
                return (
                  ...
                  >
                    ...
                    />
                    <div
                      className={`lg:w-[35px] ${visible === "block" ? "-mt-11" : "mt-7"} w-[30px] h-[30px] absolute lg:right-9 right-5  lg:h-[35px] flex flex-col justify-center items-center rounded-full bg-[#096656]`}
                    >
