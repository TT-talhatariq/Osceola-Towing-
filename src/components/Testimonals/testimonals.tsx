    ...
    <section className={`${background} lg:my-32 my-20 lg:px-14 py-12`}>
      <div className="mx-auto px-6">
        ...
        <div className="relative">
          <button
            className="absolute cursor-pointer lg:-left-14 -left-5 top-1/2 transform -translate-y-1/2 z-10"
            id="prevButton"
          >
            <FaLessThan className={`text-lg ${iconColor}`} />
          </button>
          <Swiper
            id="swiper-color"
              ...
              return (
                ...
                >
                  <div className="shadow-md lg:w-[430px] lg:h-[251px] rounded-xl py-6 px-3">
                    ...
                    <p className="text-[#666666] raleway leading-[2] lg:text-[15px] text-[13px] mb-4">
          ...
          <button
            className="absolute lg:-right-14 cursor-pointer -right-5 top-1/2 transform -translate-y-1/2 z-10 "
            id="nextButton"
          >
            <FaGreaterThan className={`text-lg ${iconColor}`} />
          </button>
        </div>
      </div>
      <style jsx>{`
