    ...
    <div>
      ...
      <div className="text-center lg:px-24 px-3 ">
        ...
        <motion.h1
          ...
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.7 }}
          className={`lg:text-[52px] ${grifter.className} lg:hidden block text-[25px] font-bold`}
        >
          Your Trusted Towing
        </motion.h1>
        <Image
        ...
        <motion.h1
          ...
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.7 }}
          className={`lg:text-[52px] ${grifter.className} text-[25px] lg:hidden block  font-bold`}
        >
      ...
      <div className="flex lg:flex-row lg:mt-20 mt-14 flex-col-reverse items-center justify-between  lg:gap-10 gap-5 bg-[#F6B620] bg-opacity-10 lg:px-24 px-5 py-10">
        <motion.div
          initial={{ opacity: 0, y: -50 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.7 }}
